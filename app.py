...
|---|---|---|
| **Normal** | 평상시 | 30 / 30 / 40 / 0 |
| **Fear (Tactical Strike)** | VIX>30 또는 (RSI<30 & VIX≥18) | 27 / 28 / **25** / **20** |
| **Greed (Profit Take)** | RSI>70 | 20 / 20 / **60** / 0 |

→ 공포장에선 QLD(20%)로 공격하되 SGOV 25%로 최소 방어, 과열장에선 SGOV 60%로 후퇴.
