...
- **진성 하락장 매수**: VIX 교차검증 통과 시 QQQM/SPYM/QLD 단계별 공격. **QLD는 추세 무관 항상 50% 공격** (위성 성격).
- **추세 필터 (Trend Filter)**: QQQM이 200일선 아래(하락추세)면 코어 매수 강도를 **절반**으로 쪼개 분할 진입. *(QLD는 예외, 항상 공격적)*
